...
- [Midnight Wallet Extension](https://github.com/Ansh-Sonkusare/midnight-extension) - Self-contained Midnight wallet as a browser extension (Manifest V3) with seed import, NIGHT send/receive, transaction history, multisig vaults with on-chain approval, and the ConnectedAPI v4 dApp connector
