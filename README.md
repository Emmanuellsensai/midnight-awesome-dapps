...
- [Anonymous Whispers](https://github.com/Emmanuellsensai/anonymous-whispers) - Privacy-preserving whistleblower dApp where reporters submit encrypted reports on Midnight Preprod. Uses in-circuit persistentHash commitments binding private witnesses, curve25519 client-side encryption (tweetnacl nacl.box), and a reusable SDK workspace package. Sender identity is cryptographically unrecoverable via single-use ephemeral keypairs. - [Demo](https://anonymous-whispers.vercel.app)
